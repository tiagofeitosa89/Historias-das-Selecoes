...
<div class="container-fluid" id="app">
    ...
    <div class="container">
        ...
        <br>
        <div class="row">
                <img class="img-responsive col-md-2" style="width: 330px; height: 200px;" src="../img/selecoes/senegal/Senegal.png">  <!--width="150px" height="120px"-->
                <div class="titulo-selecao col-md-8">
                    <h1>Seleção Senegalesa de Futebol</h1>
                    <hr>
                    <h5>
        ...
        <div class="row">
           <div class="col-md-7">
              <p align = "justify">A Seleção do Senegal participou de nove edições da Copa das Nações Africanas, sendo que seu melhor desempenho foi o vice-campeonato em 2002, perdendo a final nas penalidades para Marrocos. Mas a grande façanha dos senegaleses naquele ano foi a primeira e única participação do país em Copas do Mundo. Após estrear com vitória de 1x0 sobre os franceses – na época, os atuais campeões mundiais – Senegal se classificou para a fase seguinte com mais dois empates, diante de Dinamarca e Uruguai. As duas seleções campeãs do mundo foram eliminadas ainda na fase de grupos. Nas oitavas-de-final, Senegal enfrentou a Suécia e após 1x1 no tempo normal, avançou com um ”Gol de Ouro” de Henri Camara, que também foi o autor do gol senegalês nos 90 minutos regulamentares. A eliminação para a Turquia, também na prorrogação, não tirou o brilho da campanha de Senegal, a segunda seleção africana a chegar as quartas-de-final de uma Copa do Mundo – a primeira foi Camarões, em 1990; Gana repetiria o feito em 2010. Apesar do bom ano de 2002, até 2012, os senegaleses não conseguiram uma segunda classificação para mundiais.</p>
			  <p align = "justify">O Senegal, que se prepara para disputar a segunda Copa de sua história, é o representante do continente africano com maiores possibilidades de desempenhar um bom papel neste Mundial. A equipe provou seu valor ao se classificar com folga em um grupo complicado nas Eliminatórias, com Burkina Faso, Cabo Verde e África do Sul. Terminou invicta, com quatro vitórias e dois empates, e um aproveitamento de 77,8%.</p>
			  <p align = "justify">Todos os setores do time apresentam muita consistência, mas é no trio de ataque formado por M’Baye Niang, do Torino, Keita Baldé, do Mônaco, e Sadio Mané, do Liverpool, que se concentram as maiores esperanças da torcida. O time normalmente joga no 4-3-3, mas  o técnico Alio Cissé costuma  variar o esquema para um 4-2-2 quando a exigência defensiva é maior.</p>
			  <p align = "justify">Em um dia inspirado, a seleção senegalesa é perfeitamente capaz de fazer frente a qualquer outra equipe do Grupo H.</p>
           </div> <!--texto seleção-->
